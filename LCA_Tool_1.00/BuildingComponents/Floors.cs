...
namespace LCA_Tool.BuildingComponents
{
    ...
    internal class Floors
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            foreach (Element element in collector)
            {
                ...
                try // try bruges da ellers mange elementer ville give fejl hvis man prøver at tage deres categori, hvis de ikke har en.
                {
                    if (element.Category.Name == "Floors")
                    {
                        ...
                        string id = floor.Id.ToString();
                        double areaFeet = floor.get_Parameter(BuiltInParameter.HOST_AREA_COMPUTED).AsDouble();
            ...
            File.WriteAllText(@"C:\Users\oskar\OneDrive - Danmarks Tekniske Universitet\Kandidat Speciale\Programmering\RevitQuantities\json_floor.json", json);
